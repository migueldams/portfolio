...
function Footer() {
  return (
    <div className="w-full min-h-100 flex flex-col  items-center justify-between border-t-4 border-amber-500 bg-gray-900 text-white ">
      <div className='w-full grid grid-cols-1 md:grid-cols-3 gap-20 py-20 px-10'>
        ...
        <div className='space-y-8'>
          ...
          <ul className='flex gap-4 items-center'>
            <li><a href="#home" className='hover:text-amber-400 cursor-pointer '>Home</a></li>
            <li><a href="#about" className='hover:text-amber-400 cursor-pointer'>About</a></li>
            <li><a href="#projects" className='hover:text-amber-400 cursor-pointer'>Projects</a></li>
            <li><a href="#contact" className='hover:text-amber-400 cursor-pointer'>Contact</a></li>
          </ul>
      ...
      <div className="w-full h-16 flex flex-col md:flex-row items-center justify-around bg-black text-white">
        <p>© 2025 Miguel Portfolio. All rights reserved.</p>
