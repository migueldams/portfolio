...
export const AnimatedSpan = ({
  ...
  return (
    <motion.div
      ...
      className={cn("grid text-sm font-normal tracking-tight text-green-400", className)}
      onAnimationComplete={() => {
        if (!sequence) return
...
export const TypingAnimation = ({
  ...
  return (
    <MotionComponent
      ref={elementRef}
      className={cn("text-sm font-normal tracking-tight text-orange-600", className)}
      {...props}
    >
      {displayedText}
    </MotionComponent>
